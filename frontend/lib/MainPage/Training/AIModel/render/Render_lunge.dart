...
class RenderDataLunge extends StatefulWidget {
  ...
  RenderDataLunge(
      ...
      this.count});
  @override
  _RenderDataLungeState createState() => _RenderDataLungeState();
}

class _RenderDataLungeState extends State<RenderDataLunge> {
  Map<String, List<double>> inputArr;

  String excercise = 'lunge';
        ...
        Align(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                Text(
                  '$whatToDo \Lunge: ${_counter.toString()}',
