...
class RenderDataJumpSquat extends StatefulWidget {
  ...
  RenderDataJumpSquat(
      ...
      this.count});
  @override
  _RenderDataJumpSquatState createState() => _RenderDataJumpSquatState();
}

class _RenderDataJumpSquatState extends State<RenderDataJumpSquat> {
  Map<String, List<double>> inputArr;

  String excercise = 'Jump Squat';
    ...
    setState(() {
      ...
      if (_counter == widget.count) {
        Navigator.pushReplacement(
            context,
            MaterialPageRoute(
                builder: (context) => ResultJumpSquat(
                      fitname: 'Jump-Squat',
                      count: widget.count,
                    )));
      }
