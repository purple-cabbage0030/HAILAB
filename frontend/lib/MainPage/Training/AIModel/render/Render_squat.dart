...
import 'package:flutter_auth/MainPage/Training/ResultPage/Res_Squat.dart';

class RenderDataSquat extends StatefulWidget {
  ...
  RenderDataSquat(
      ...
      this.count});
  @override
  _RenderDataSquatState createState() => _RenderDataSquatState();
}

class _RenderDataSquatState extends State<RenderDataSquat> {
  ...
  bool _postureAccordingToExercise(Map<String, List<double>> poses) {
    ...
    if (excercise == 'squat') {
      if (squatUp) {
        ...
        return poses['leftShoulder'][1] > 500 &&
            poses['rightShoulder'][1] > 500;
      }
    }
  }
